...
```html [index.html]
<script src="..."></scrtip>
<script type="module" src="./App.js"></scrtip>
...
export default {
  props: ['data'],
  template: '<div style="color: skyblue">{{data.name}}-{{data.age}}</div>',
}
```
