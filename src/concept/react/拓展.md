...
## React拓展PureComponent

### React拓展Component的2个问题
...
1. 办法一: 重写 `shouldComponentUpdate()` 方法
...
## React拓展ErrorBoundary

### React拓展ErrorBoundary理解

错误边界( Error boundary )：用来捕获后代组件错误，渲染出备用页面

### React拓展ErrorBoundary特点

只能捕获后代组件生命周期产生的错误，不能捕获自己组件产生的错误和其他组件在合成事件、定时器中产生的错误

### React拓展ErrorBoundary使用方式
