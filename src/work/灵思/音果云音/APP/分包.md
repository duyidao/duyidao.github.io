...
将<word text="微信小程序" />的代码和资源拆分成多个包，按需加载，减少主包体积，提升首屏加载速度。
...
```json
{
  "pages": ["pages/index/index", "pages/login/login", "pages/common/about"],

  "subpackages": [
    {
      "root": "subpackages/audio",
      "name": "audio",
      "pages": ["pages/player/player", "pages/playlist/playlist"],
      "independent": false // 是否独立分包
    },
    {
      "root": "subpackages/payment",
      "name": "payment",
      "pages": ["pages/alipay/alipay", "pages/wechat/wechat"]
    },
    {
      "root": "subpackages/user",
      "name": "user",
      "pages": ["pages/profile/profile", "pages/orders/orders"],
      "independent": false
    }
  ],
