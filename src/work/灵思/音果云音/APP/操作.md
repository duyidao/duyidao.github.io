...
用户需要 `app` 连接蓝牙设备进行各自操作的功能，<word text="UniApp" /> 有对应的 `API` 可以使用，详情请见 [蓝牙](https://uniapp.dcloud.net.cn/api/system/bluetooth.html#openbluetoothadapter) 与 [低功耗蓝牙](https://uniapp.dcloud.net.cn/api/system/ble.html) 。
