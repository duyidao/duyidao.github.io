...
回顾阴影的基础语法，更多细节可参考 [MDN 阴影](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/box-shadow)。
...
大多数场景下阴影是两侧或四周都有，如果希望阴影只在一侧，该怎么做？
...
这两个是全然相反的浮雕阴影效果，一个是凹一个是凸。只需要修改字体阴影色值就能实现相反的效果。
