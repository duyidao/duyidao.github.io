    ...
    items: [
      {
        ...
        collapsed: true,
        items: [
          { text: '设计模式', link: '/idea/design/' },
          {
            text: '视频列表只允许单个视频播放',
            link: '/idea/design/oneVideo',
          },
          {
            text: '商品卡不同类型代码如何实现',
            link: '/idea/design/differentShop',
          },
          { text: '请求的复用与兼容', link: '/idea/design/reuse' },
        ],
      },
      {
        text: 'Promise',
        ...
        items: [
          {
            ...
            collapsed: true,
            items: [
              { text: '类与.then', link: '/idea/write/' },
              { text: 'catch与finally', link: '/idea/write/catch' },
              { text: '静态方法', link: '/idea/write/status' },
            ],
          },
          { text: '请求取消', link: '/idea/abort' },
          {
            text: '如何避免相同的请求重复发送',
            link: '/idea/abortSame',
          },
          { text: 'Axios二次封装', link: '/idea/twice' },
          { text: '并发请求封装', link: '/idea/concurrency' },
          { text: '并发任务控制', link: '/idea/control' },
          { text: '消除异步传染性', link: '/idea/infect' },
          { text: '高量级任务执行优化', link: '/idea/task' },
        ],
      },
      {
        text: '类',
        collapsed: true,
        items: [{ text: '类的多态', link: '/idea/class/polymorphism' }],
      },
      {
        text: '算法',
        collapsed: true,
