    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '请求取消', link: '/idea/promise/请求取消abort' },
          {
            text: '如何避免相同的请求重复发送',
            link: '/idea/promise/如何避免相同的请求重复发送',
          },
          { text: 'Axios二次封装', link: '/idea/promise/Axios二次封装' },
          { text: '并发请求封装', link: '/idea/promise/并发请求封装' },
          { text: '并发任务控制', link: '/idea/promise/并发任务控制' },
          { text: '消除异步传染性', link: '/idea/promise/消除异步传染性' },
          {
            text: '高量级任务执行优化',
            link: '/idea/promise/高量级任务执行优化',
          },
        ],
      },
      {
